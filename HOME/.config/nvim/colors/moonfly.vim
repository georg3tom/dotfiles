...
let s:grey234   = '#1b1b1b' " grey234     = 234
...
exec 'highlight CursorLineNr ctermbg=234 ctermfg=4 cterm=none guibg=' . s:grey234 . ' guifg=' . s:white . ' gui=none'
...
exec 'highlight ColorColumn ctermbg=233 guibg=' . s:grey0
...
highlight! link LspDiagnosticsSignHint MoonflyBlue
