...
" MODES SUPPORT
" NORMAL MODE ---------------------------------------------------------------{{{
let s:N1 = [ s:guiWhite     , s:guiPale , s:ctermWhite     , s:ctermGray ]
let s:N2 = [ s:guiBlack		, s:guiWhite , s:ctermLightgray , s:ctermGray  ]
...
" }}}
" INSERT MODE ---------------------------------------------------------------{{{
let s:I1 = [ s:guiGreen , s:guiPale , s:ctermGreen , s:ctermBlack ]
...
" }}}
" VISUAL MODE ---------------------------------------------------------------{{{
let s:V1 = [ s:guiBlue  , s:guiPale , s:ctermBlue  , s:ctermBlack ]
...
" }}}
" REPLACE MODE --------------------------------------------------------------{{{
let s:R1 = [ s:guiOrange , s:guiPale  , s:ctermOrange , s:ctermBlack  ]
